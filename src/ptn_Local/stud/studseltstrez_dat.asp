...
<%
 ...
 myCmd.CommandText = "GetTestsResultsSumar"
 myCmd.CommandType = adCmdStoredProc
 Set rs = myCmd.Execute(,Array(CLng(Request.QueryString("userid")),CLng(Session("CursID"))))
 ...
 do until rs.EOF
   with Response
    ...
    .Write NullToZero(rs.Fields("NrRezolvariNetermin").value) & vbCrLf
   end with
   rs.MoveNext
 loop        
 rs.Close
